...
For the short setup path, see the repository [README](../README.md). Use `scripts\Restore-And-Build.ps1` to restore packages and build from a Developer PowerShell or a normal PowerShell session.
